...
INSERT INTO `bank` (`idBank`, `namaBank`) VALUES
(1, 'BCA'),
(2, 'BRI'),
(3, 'MANDIRI');
...
(14, 763, 'Verifikasi Berhasil', 'Permintaan anda berhasil diterima Topi New York <form action=\"pembayaranOffer\" method=\"GET\">\r\n					<button  id=\"pembayaranOffer\" style=\"color:#f3310a;\" class=\"w3-bar-item w3-display-inline  w3-btn\" >Klik di Sini Untuk Pembayaran</button>\r\n					<input type=\"hidden\" name=\"namaBarang\" value=\"Topi New York\">\r\n					<input type=\"hidden\" name=\"totalHarga\" value=\"114000\">\r\n					<input type=\"hidden\" name=\"hargaBarang\" value=\"100000\">\r\n					<input type=\"hidden\" name=\"kotaAwal\" value=\"Bandung\">\r\n					<input type=\"hidden\" name=\"kotaTujuan\" value=\"Paris\">\r\n					<input type=\"hidden\" name=\"waktuAwal\" value=\"\">\r\n					<input type=\"hidden\" name=\"waktuAkhir\" value=\"\">\r\n					<input type=\"hidden\" name=\"deskripsi\" value=\"Warna Hitam\">\r\n					<input type=\"hidden\" name=\"tipTraveller\" value=\"10000\">\r\n					<input type=\"hidden\" name=\"gambar\" value=\"topi.jpg\">\r\n					<input type=\"hidden\" name=\"fee\" value=\"4000\">\r\n					<input type=\"hidden\" name=\"kodeUnik\" value=\"749\">\r\n					</form>', 0, '2020-12-31 00:47:32'),
(29, 764, 'Verifikasi Pending', 'Trip anda sedang diproses', 1, '2020-12-31 00:50:21'),
(29, 765, 'Verifikasi Berhasil', 'Trip anda sudah diverifikasi', 1, '2020-12-31 00:50:38'),
(29, 766, 'Verifikasi Pending', 'Offer an Item Anda dengan nama Celana jeans Pria Panjang sedang diproses', 1, '2020-12-31 00:51:31'),
(29, 767, 'Verifikasi Berhasil', 'Offer an Item Anda dengan nama Celana jeans Pria Panjang \r\n                telah berhasil disetujui. Sekarang barang anda sudah ada di fitur Market (Offer an Item).', 1, '2020-12-31 00:51:47'),
(29, 768, 'Verifikasi Penitipan Barang(Offer Item)', 'Ada customer yang memesan barang anda dengan nama Celana jeans Pria Panjang <form action=\"persetujuanTraveller\" method=\"GET\">\r\n					<button  id=\"persetujuanTraveller\" style=\"color:#f3310a;\" class=\"w3-bar-item w3-display-inline  w3-btn\" >Klik di Sini Untuk Persetujuan Penitipan</button>\r\n					<input type=\"hidden\" name=\"namaBarang\" value=\"Celana jeans Pria Panjang\">\r\n					<input type=\"hidden\" name=\"namaKategori\" value=\"Fashion\">\r\n					<input type=\"hidden\" name=\"hargaDiJual\" value=\"250000\">\r\n					<input type=\"hidden\" name=\"hargaOngkir\" value=\"20000\">\r\n					<input type=\"hidden\" name=\"totalHarga\" value=\"280000\">\r\n					<input type=\"hidden\" name=\"deskripsi\" value=\"Warna jeans\">\r\n					<input type=\"hidden\" name=\"kotaAwal\" value=\"Bandung\">\r\n					<input type=\"hidden\" name=\"kotaTujuan\" value=\"Paris\">\r\n					<input type=\"hidden\" name=\"gambar\" value=\"celana jeans.jpg\">\r\n					<input type=\"hidden\" name=\"idUser\" value=\"28\">\r\n					</form>', 1, '2020-12-31 01:04:12'),
(28, 769, 'Verifikasi Berhasil', 'Permintaan anda berhasil diterima Celana jeans Pria Panjang <form action=\"pembayaranOffer\" method=\"GET\">\r\n					<button  id=\"pembayaranOffer\" style=\"color:#f3310a;\" class=\"w3-bar-item w3-display-inline  w3-btn\" >Klik di Sini Untuk Pembayaran</button>\r\n					<input type=\"hidden\" name=\"namaBarang\" value=\"Celana jeans Pria Panjang\">\r\n					<input type=\"hidden\" name=\"totalHarga\" value=\"280000\">\r\n					<input type=\"hidden\" name=\"hargaBarang\" value=\"250000\">\r\n					<input type=\"hidden\" name=\"kotaAwal\" value=\"Bandung\">\r\n					<input type=\"hidden\" name=\"kotaTujuan\" value=\"Paris\">\r\n					<input type=\"hidden\" name=\"waktuAwal\" value=\"\">\r\n					<input type=\"hidden\" name=\"waktuAkhir\" value=\"\">\r\n					<input type=\"hidden\" name=\"deskripsi\" value=\"Warna jeans\">\r\n					<input type=\"hidden\" name=\"tipTraveller\" value=\"20000\">\r\n					<input type=\"hidden\" name=\"gambar\" value=\"celana jeans.jpg\">\r\n					<input type=\"hidden\" name=\"fee\" value=\"10000\">\r\n					<input type=\"hidden\" name=\"kodeUnik\" value=\"113\">\r\n					</form>', 1, '2020-12-31 01:14:20'),
(28, 770, 'Pembayaran Berhasil', 'Cek barang anda di tracking kami', 1, '2020-12-31 01:28:31'),
(29, 771, 'Pembayaran Berhasil', 'Silahkan diproses barang yang akan dibeli', 1, '2020-12-31 01:28:31');
...
CREATE TABLE `transaksi` (
  ...
  `idBankPembayaran` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `transaksi` (`idUser1`, `IdTrip`, `idUser2`, `jumlahBarang`, `hargaBarang`, `hargaOngkir`, `hargaJasa`, `namaBarang`, `statusBarang`, `deskripsiBarang`, `gambarBarang`, `noresi`, `idKategori`, `buktiPembayaran`, `kodeUnik`, `statusPembayaran`, `idBankPembayaran`) VALUES
...
(29, 36, 14, 1, 100000, 10000, 4000, 'Topi New York', 'onPayment', 'Warna Hitam', 'topi.jpg', NULL, 1, 'yes sir.png', '215', NULL, NULL),
...
(29, 40, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(29, 40, 28, 1, 250000, 20000, 10000, 'Celana jeans Pria Panjang', 'onDelivery', 'Warna jeans', 'celana jeans.jpg', NULL, 1, 'buktiPembayaran.PNG', NULL, 'verified', 0);
...
(40, '2020-12-31 00:00:00', '2021-01-09 00:00:00', 'verified', 'tiketPesawat.jpg', 39, 40);
...
--
ALTER TABLE `negara`
  MODIFY `idNegara` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `notifikasi`
--
ALTER TABLE `notifikasi`
  MODIFY `idNotifikasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=772;
...
--
ALTER TABLE `trip`
  MODIFY `idTrip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
