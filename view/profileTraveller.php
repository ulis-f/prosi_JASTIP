...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
    <div class="w3-row">
        ...
        <!-- Profile -->  
            <div class="w3-card w3-round w3-white">
                ...
                <p><i class="fa fa-phone fa-fw w3-margin-right w3-text-theme"></i> 0822134567</p>
                <p><i class="fa fa-envelope fa-fw w3-margin-right w3-text-theme"></i>u@gmail.com</p>
                <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i>Bandung</p>  
            </div>
        </div>
        <!-- End Left Column -->
    </div>
    ...
    <div class="w3-col m7">
        <div class="w3-row-padding">
            ...
            <h4 style="margin:auto; margin-left: 10%;">Perjalanan yang Masih Aktif</h4>
                <?php
                    ...
                    echo"<div class='w3-card w3-round w3-white' style='width:80%; margin: auto; margin-top:5%;'>";
                        ...
                        echo"<table>";
                            ...
                            echo"<tr>";
                                ...
                                echo"<td></td>";
                                echo"<td></td>";  
                                echo"<td rowspan='2' style='padding-left:20%;'><a href='titipBarang'><button style='float:right;'>Titip Barang</button></a></td>";
                            echo"</tr>";
                            echo"<tr>";
