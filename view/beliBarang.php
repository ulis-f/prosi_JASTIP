<style>
    ...
    <div class="container">
        <div class="w3-card-4 w3-white" style="width:60%; margin: auto; padding: 50px; height: 1175px; margin-top: 5%;">
            <form action="" method="POST">
                <h2>Penitipan Barang</h2> 
                    ...
                    ?><br> 
                    <tr> 
                        <td><label>Harga Dijual</label></td>
                        <td>:</td>
                        <td><input id="harga" class="w3-input w3-border w3-border-theme" name="hargaDiJual" type="text" onkeyup="hitung()"></td>
                    </tr>
                    <tr> 
                        <td><label>Harga Ongkir</label> </td>
                        <td>:</td>
                        <td><input id="hargaOngkir" class="w3-input w3-border w3-border-theme" name="hargaOngkir" type="text" onkeyup="hitung()"></td>
                    </tr>
                    <tr>
