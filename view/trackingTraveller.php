        ...
        <div class="w3-card-4 w3-white" style="padding: 50px; height: 800px; margin-top: 5%;">
            ...
            <fieldset>
                <table class="no-spacing" cellspacing="0">
                    <tr>
                        <td rowspan='2' style='width: 15%; padding: 10px;'><b>Nama Barang</b></td> 
                        ...
                        <div style="width: 46%;">
                            <td style='float: left; width: 45%; padding: 10px;'><h5>Kota awal</h5> </td>
                            <td style='float: right; padding: 10px ; border-right:#dddddd 1px solid;'><h5>Kota akhir</h5></td>
                        </div>
                    ...
                    <tr>
                        <td style='float:left; padding: 10px;'><b>waktu awal</b></td>  
                        <td style='float: right; padding: 10px;'><b>waktu akhir</b></td>
                    </tr>
                </table>
            </fieldset>
                                    ...
                                    <div class="inner_div">
                                        ...
                                        <div id="status4"  style="display: none;">
                                            <div style="float: right;width: 48%;">
                                                ...
                                                <input required class="w3-input w3-border w3-border-theme" placeholder="Masukkan No.Resi" type="text" id="noResi">
                                                <div class="w3-right" style="padding-top: 10%; padding-right:1%"> 
