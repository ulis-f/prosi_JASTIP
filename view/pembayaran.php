    ...
    <div class="w3-card w3-white" style="padding: 50px; height: 800px; margin-top: 3%;">
        <form action="pembayaranKeAdmin" method="POST" enctype="multipart/form-data">
            ...
            ?>
                ...
                <div class="container">
                    <div class="col-sm-4">
                        <img src="../view/image/bank/bca.png" class="active" name="jenisBank" id="jenisBank" value="bca" onclick="toggleVisibility('bank');" alt="" style="width: 100%; border: 2px solid #dddddd; padding:8px; cursor:pointer;">
                    </div>
                ...
                <table>
                    <tr>
                        <td><input type='radio' style="margin-left:30px;" id='BCA' name='namaBank' value='BCA' onclick="toggleVisibility('bank');">BCA
            </div>
            </td>
            <td><input type='radio' style="margin-left:110px;" id='BRI' name='namaBank' value='BRI' onclick="toggleVisibility('bank1');">BRI
    </div>
    </td>
    <td><input type='radio' style="margin-left:110px;" id='MANDIRI' name='namaBank' value='MANDIRI' onclick="toggleVisibility('bank2');">MANDIRI
</div>
</td>
</tr>
</table>
