<ul class="nav nav-tabs justify-content-left" style="background-color:white;"> 
    <li class="nav-item">
        <a class="nav-link w3-text-theme" href="#" style="border-bottom: 4px solid red; height: 100%;">Wanted Item</a>
    </li>
    <li class="nav-item w3-text-theme">
        <a class="nav-link text-center w3-text-theme" href="" style="height: 100%;">Offer Item</a>
    </li>
</ul>

<div style="margin-top:1%; margin-bottom:2%;padding-left:15px">
    <h6>Want a request <a id="wanted" href="" onclick=" " style="color:#b74449;">+Want</a></h6>
</div>
